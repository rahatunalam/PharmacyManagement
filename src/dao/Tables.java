...
public class Tables {
    ...
    public static void main(String[] args) {
        try {
            ...
            //     st.executeUpdate("Insert into appuser (userRole,name,dob,mobileNumber,email,username,password,address) values('Admin','Admin','16-12-1992','01740356019','admin@gmail.com','admin','admin','Bangladesh')");
            //st.executeUpdate("create table medicine(medicine_pk int AUTO_INCREMENT primary key,name varchar(200),companyName varchar(200),quantity bigint,price bigint)");
